...
class PostController extends Controller
{
    ...
    public function store(Request $request) {
        $params = $request->only('name', 'image', 'category', 'content', 'status', 'category_id', 'title', 'keywords', 'description', 'bookcontents', 'book_subtitle', 'author', 'book_authorsymbol', 'category_name', 'book_language', 'book_number', 'book_episode');
